...
void NoiseGLOriginal::wheelEvent(QWheelEvent *event) {
...
void NoiseGLOriginal::setDimensions(int rotationX, int rotationY, float last_x, float last_y, double zoom) {
